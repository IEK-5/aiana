...
class BR_Wrapper():
    ...
    scene: br.SceneObj = None
    oct_file_name: str = None
    met_data: br.MetObj = None
    ...
    def __init__(
        ...
        self.setup_br(sky_gen_type, cellLevelModule, EPW)
    ...
    def calculate_properties(self):
        self.ygrid = self.get_ygrid()
        self.xfield: int = round(
            self.sceneDict['nMods'] * self.moduleDict['x']) + 2*2

    def setup_br(self, sky_gen_type='gendaylit',
                 cellLevelModule=False,
                 EPW=True):
        ...
        Args:
            ...
            or 'gencumsky' for annual perez model.
        ...
        self.radObj: br.RadianceObj = radObj
        self.scene: br.SceneObj = scene
        self.oct_file_name: str = scene
        self.met_data: br.MetObj = met_data

    def view_oct_file_with_rvu(view_fp: str, oct_file_name=s.name):
    ...
    def set_groundscan(groundscan: dict) -> dict:
        ...
        Returns:
            groundscan (dict)
        """
        groundscan['xstart'] = - self.calc_x_field() / 2
