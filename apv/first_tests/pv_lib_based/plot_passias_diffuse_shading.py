...
for k in [1, 1.5, 2, 2.5, 3, 4, 5, 7, 10]:
    # k equals distance between the modules divided by the lengths of a module
    # whereby the modules are placed behind each other in a row
    # if the distance is larger than the lengths, the masking (shadowing) angle
    # decreases and the irradiance increases
    gcr = 1/k
