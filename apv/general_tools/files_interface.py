...
def Join_relPath_toHomePath_AndMakeDirsIfNotThere(rel_path:str, path_main = path_main):
...
def save_fig(fig, file_name, rel_path = '', file_formats = ['.jpg'], dpi = 300, transparent = False):    
