...
for aggfunc in ['min', 'max', 'mean', 'median']:
    aiana.settings.sim.TMY_irradiance_aggfunc = aggfunc
    helper(aiana.weatherData.df_irradiance_to_TMY(),
...
# #
# non- tmy (complete)
df_all = aiana.weatherData.load_and_process_insolation_data()
...
# #
df_tdm = aiana.weatherData.df_irradiance_typ_day_per_month
cumulative_GHIs = {}
df = df_all.copy()
