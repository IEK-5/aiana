...
from aiana.utils.files_interface import save_fig, df_from_file_or_folder
import pandas as pd
import aiana.settings.user_paths as user_paths
from pathlib import Path
from datetime import datetime as dt
import numpy as np
import aiana.utils.time as t
from matplotlib import pyplot as plt
from aiana.utils.files_interface import save_fig
import aiana
...
aiana.utils.files_interface.save_fig(fig, 'daily integral_min_mean_max')
