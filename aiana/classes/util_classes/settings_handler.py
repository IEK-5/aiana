...
from aiana.settings.view_settings import ViewSettings
from aiana.settings.sim_settings import SimSettingsDefault
from aiana.settings.user_paths import UserPaths
...
class Names:
    ...
    def __init__(self, SimSettings: SimSettingsDefault,
...
class Paths(UserPaths):
    def __init__(self, SimSettings: SimSettingsDefault, names: Names):
