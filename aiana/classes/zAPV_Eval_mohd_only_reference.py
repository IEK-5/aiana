...
class Evaluator:
    ...
    def evaluate_APV(self, SimSettings: SimSettingsDefault):
        ...
        # Adjust settings
        self.settings.apv = aiana.utils.settings_adjuster.adjust_settings(
            self.settings.apv)
    ...
    def estimate_energy(self, SimSettings: SimSettingsDefault,
                        APV_SystSettings: APV_System,
                        time, timeindex,
    ...
    def get_weather_data(self, SimSettings: SimSettingsDefault):
    ...
    def add_shadowdepth(self, df, SimSettings: SimSettingsDefault, cumulative=False):
